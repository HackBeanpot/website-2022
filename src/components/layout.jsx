  ...
  return <div className={`parent ${isDarkTheme ? "" : "light"}`}>
    <Helmet
      ...
      meta={[
        ...
        {
          name: 'keywords',
          content: 'hackbeanpot, hackathon, boston, 2022, students, hackers, makers, beginners, hack, beanpot, virtual, online, free, learning, learn, computer science, programming, program, coding, code, projects, technical, makeathon, coding, java, python, react, college, high school, tech scene, technology, tech, stem, education, engineering, software engineer, diversity in tech, technical skills, conference, workshops, tech industry, professionals'
        },
        {
          name: 'theme-color',
          content: '#A4DBE8'
